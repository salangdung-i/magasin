			...
			<div class="mainContainer">
				    ...
				    <form action="/join" onsubmit="return checkz()" method="post" id="memberJoin">
				    	...
				    	<table class="join-div-table" style="width:100%;">
				    		<tr>
							    ...
							    <td><input type="text" name="id" id="id" class="form-control" required><span id="idChkMsg"></span></td>
				    		</tr>
							<tr>
								<th><label for="pw">비밀번호 <img src="img/ico_required_blue.gif"></label></th>
								<td><input type="password" name="pw" id="pw" class="form-control" required><span>(영문 대소문자/숫자/특수문자 포함한 8자~15자)</span><span id="pwChk"></span></td>
							</tr>
							<tr>
				            ...
				            <tr>
				                <th>성별</th>
				                <td>
				                    <input type="radio" name="gender" id="female" value="여성" class="form-control">&nbsp;<label for="female">여성</label>&nbsp;&nbsp;&nbsp;
				                    <input type="radio" name="gender" id="male" value="남성" class="form-control">&nbsp;<label for="male">남성</label>
				                </td>
				            </tr>
				            <tr>
				...
				“슬로우앤드”는 회원가입, 주문안내, 배송안내 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며, 만약 알림톡 수신이 불가능하거나 수신 차단하신 경우에는 일반 문자메시지로 보내드립니다. 카카오톡 알림톡을 통해 안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할 경우, 알림톡 수신 중 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 발송되는 알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여 주시기 바랍니다.
				                    ...
				                    <p class="check">
				                        ...
				                        <input type="checkbox" id="agreeSerChk" name="agreeSerChk" value="Y">
				...
				※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.</p>    
				                    ...
				                    <p class="check">
				                        ...
				                        <input type="checkbox" id="agreePrvChk" name="agreePrvChk" value="Y">
	   ...
	   $(document).ready(function(){
	       ...
	       $("#agreeChkAll").click(function(){
	           ...
	           if($("#agreeChkAll").prop("checked")){
	               ...
	               $("input[name=agreeSerChk]").prop("checked",true);
	               $("input[name=agreePrvChk]").prop("checked",true);
	               //클릭이 안되있으면
	           }else{
	               //input태그의 name이 agreeSerChk,agreePrvChk인 태그들을 찾아서 checked옵션을 false로 정의
	               $("input[name=agreeSerChk]").prop("checked",false);
	               $("input[name=agreePrvChk]").prop("checked",false);
	               return false;
	           }
	       });
	   });
