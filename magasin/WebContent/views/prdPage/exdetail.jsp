                  ...
                  <form id="Sub" action="/productExpay" method="post">
                     ...
                     <div class="table-wrapper">
                        <p><%=pdI.getPrdName()%></p>
                         ...
                         <input type="hidden" class="prdSnImgpath" name="prdSnImgpath" value="<%=pdI.getPrdSnImgpath()%>">
                        ...
                        <table class="table detail-table">
                           ...
                           <tr>
                              ...
                              <%for( String color : colors ){ %>
                                 ...
                                 <%}%>
                                 <input type="hidden" class="prdDtlColor" id="prdDtlColor" name="prdDtlColor">

                              </td>
                           </tr>
                           <tr>
                              <th>size</th>
                              <td><select class="prdDtlSize" id="sizes" name ="size">
  ...
  50% {
   ...
   function goToBasket(){
      ...
      var price = $('.prdPrice').val()
       ...
       var url = prdId+"/"+prdName+"/"+price+"/"+size+"/"+color+"/"+count+"/"+userId ; 
       alert(url);
