		...
		.generate({
			...
			data : {
				columns : [
						...
						[ "결제금액", 510000, 1110000, 725000, 1210500, 687500,
								1081000 ] ],
				colors : {
					결제건수 : "#41c572",
					결제금액 : "#26a2ec"
...
let chart2 = c3.generate({
	...
	data : {
		columns : [ [ "시간별 결제건수", 20, 11, 10, 0, 0, 0, 0, 1, 0, 3, 10, 2, 13,
				15, 3, 2, 0, 0, 8, 12, 20, 23, 24, 15 ] ],
		types : {
			data1 : "area"
		}
	}
...
let chart3 = c3.generate({
	bindto : ".top-canvas3",
	data : {
		columns : [ [ "남성", 1, 4, 0, 10, 2 ], [ "여성", 10, 30, 20, 40, 50 ],
...
let chart4 = c3.generate({
	...
	data : {
		columns : [ [ "10대", 10, 5, 1, 4, 1 ], [ "20대", 20, 30, 50, 42, 35 ],
				[ "30대", 1, 3, 8, 12, 1 ], [ "40대 이상", 0, 0, 1, 0, 2 ],
				[ "알수없음", 10, 30, 20, 40, 50 ] ],
		colors : {
			알수없음 : "#cccccc"
		},
