...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%
       //SerchIdervlet에서 키값 m1,m2를 받아옴
       Member m = (Member)request.getAttribute("member"); //이름,이메일로 찾을 때
       //Member m2 = (Member)request.getAttribute("m2"); //이름,전화번호로 찾을 때 
    %>
      ...
      <section>
         <div class="mainContainer">
            ...
            <div class="mainContent" style="width: 943px;">
               <div class="main">
                   <div class="main_h3"><h3>비밀번호 찾기 완료</h3></div>
                      <div class="container">
                        <h4><%=m.getName() %>님의 비밀번호 확인 결과입니다.</h4>
