	...
	<div class="mainContent">
		<div class="myp-wrapper">
			<div class="myp-div1">
				...
				<span><%=member.getName()%></span>님은 <span><%=member.getGrade()%></span>
				회원이십니다.
			</div>
			<%
				int count1 = 0;
			...
			<div class="myp-div2">
				...
				<div class="myp-div2-d2">
					...
					<ul class="myp-div2-d2-ul1">
						<li><strong>배송준비중</strong><br>
						<a><%=count1%></a></li>
						<li><strong>배송중</strong><br>
						<a><%=count2%></a></li>
						<li><strong>배송완료</strong><br>
						<a><%=count3%></a></li>
					</ul>
			...
			<div class="myp-div3">
				<ul class="myp-div3-ul">
					<li class="myp-div3-ul-li1">
						<h3>
							<img src="/img/myPage/myp-order.png"> <a
								href="/orderList?id=<%=member.getId()%>">Order</a>
						</h3> <pre>주문내역 조회</pre>
						<p>
					...
					<li class="myp-div3-ul-li2">
						<h3>
							<img src="/img/myPage/myp-profile.png"> <a
								href="/update?id=<%=member.getId()%>">Profile</a>
						</h3> <pre>회원 정보</pre>
						<p>
							고객님의 개인정보를 <br>관리하는 공간 입니다.
						</p>
					</li>
					<li class="myp-div3-ul-li3">
						<h3>
							<img src="/img/myPage/myp-cart1.png"> <a
								href="/listBasket?id=<%=member.getId()%>">Basket</a>
						</h3> <pre>장바 구니</pre>
						<p>
							장바구니에 등록하신 <br>상품 목록을 보여드립니다.
						</p>
					</li>
